 ...
 */
function ref_preprocess_html(&$variables) {
 ...
 */
function ref_process_html(&$variables) {
 ...
 */
function ref_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function ref_preprocess_maintenance_page(&$variables) {
  if (!$variables['db_is_active']) {
    unset($variables['site_name']);
  }
  drupal_add_css(drupal_get_path('theme', 'ref') . '/css/maintenance-page.css');
}

/**
 * Override or insert variables into the maintenance page template.
 */
function ref_process_maintenance_page(&$variables) {
  // Always print the site name and slogan, but if they are toggled off, we'll
  // just hide them visually.
  $variables['hide_site_name']   = theme_get_setting('toggle_name') ? FALSE : TRUE;
  $variables['hide_site_slogan'] = theme_get_setting('toggle_slogan') ? FALSE : TRUE;
 ...
 */
function ref_preprocess_node(&$variables) {
 ...
 */
function ref_preprocess_block(&$variables) {
 ...
 */
function ref_menu_tree($variables) {
 ...
 */
function ref_field__taxonomy_term_reference($variables) {
  $output = '';
